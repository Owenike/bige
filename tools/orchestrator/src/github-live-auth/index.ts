...
function buildGitHubAuthSmokeEvidence(params: {
  ...
  return {
    ...
    sandboxProfileSelectionMode: params.registryResolution.selectionMode,
    sandboxProfileSelectionReason: params.registryResolution.selectionReason,
...
export function applyGitHubAuthSmokeToState(state: OrchestratorState, result: GitHubAuthSmokeResult, evidence: GitHubLiveAuthEvidence) {
  ...
  return orchestratorStateSchema.parse({
    ...
    selectedSandboxProfileId: evidence.sandboxTargetProfileId,
    sandboxProfileSelectionMode: evidence.sandboxProfileSelectionMode,
    sandboxProfileSelectionReason: evidence.sandboxProfileSelectionReason,
    ...
    lastLiveSmokeTarget: result.target,
