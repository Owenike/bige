...
export const gptCodeRecoveryQueueClassificationSchema = z.enum([
  "not_applicable",
  "resumable",
  "replayable",
  "retryable",
...
export const gptCodeAutomationStateSchema = z.object({
  ...
  recoveryQueueClassification: gptCodeRecoveryQueueClassificationSchema.default("not_applicable"),
...
const gptCodeAutomationStateJsonSchema: JsonSchema = {
  ...
  properties: {
    ...
    recoveryQueueClassification: {
      type: "string",
      enum: ["not_applicable", "resumable", "replayable", "retryable", "manual_required", "exhausted", "blocked"],
    },
    replayRecommendation: { type: "string", nullable: true },
    resumeRecommendation: { type: "string", nullable: true },
    operatorActionRecommendation: { type: "string", nullable: true },
    recentRecoveryHistory: { type: "array", items: { type: "string" } },
    repeatedFailurePattern: { type: "string", nullable: true },
    recoveryAuditSummary: { type: "string", nullable: true },
