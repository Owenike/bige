begin;
-- Restoring a cancelled schedule is the inverse of cancellation. Schedule
-- managers (including employee 06) may perform both operations at any time;
-- the +/- 30 minute attendance window only applies to completion and deduction.
